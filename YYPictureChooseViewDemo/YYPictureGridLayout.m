...
#import "YYPictureGridLayout.h"

@interface YYPictureGridLayout ()

@end

@implementation YYPictureGridLayout {
...
- (CGSize)collectionViewContentSize {
    ...
    return CGSizeMake(CGRectGetMaxX(rect), CGRectGetMaxY(rect) + 5);
}
